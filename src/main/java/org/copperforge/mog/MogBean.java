...
public class MogBean implements MogObject {
    ...
    public MogBean(Map<String, Object> fields) {
        arrayPattern = Pattern.compile(arrayPatternText);
        this.fields.clear();
        this.fields.putAll(fields);
    }

    public MogBean(Object obj) throws MogException {
        arrayPattern = Pattern.compile(arrayPatternText);
