...
class JdbcRunRepositoryTest {
    ...
    void savesLoadsAndListsMetadata() throws Exception {
        ...
        properties.getRunMetadataStore().setJdbcUrl("jdbc:h2:mem:mogrunrepo;DB_CLOSE_DELAY=-1");

        FileSystemStorageLayout layout = new FileSystemStorageLayout(properties);
        JdbcRunRepository repository = new JdbcRunRepository(layout, properties, objectMapper);
